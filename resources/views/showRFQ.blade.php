                    ...
                    <div class="table-responsive">
                        ...
                        <table id="RFQDataTable" class="table table-striped table-bordered text-nowrap w-100">
                            ...
                            <tbody id="hideRFQs">
                                ...
                                <tr>
                                    <td>{{\illuminate\Support\str::upper($pt->quote_id)}} </td>
                                    ...
                                    <td>
                                     <a href="#" class="btn btn-secondary btn-sm mb-2 mb-xl-0 getRFQname" data-toggle="modal" id="viewSingleRFQ" data-target="#viewRFQ" data-id="<?= base64_encode($pt->id); ?>" data-RFQName="<?= $pt->customer_name ?>">
                                        ...
                                        <a href="{{ route('pdfview', ['id' => base64_encode($pt->id)]) }}" data-id="<?= $pt->id; ?>" class="ubtn<?= $pt->id; ?>btn btn-secondary btn-sm mb-2 mb-xl-0" data-toggle="tooltip" data-original-title="PDF"><i class="fa fa-download"></i></a>&nbsp;&nbsp;
                                        <span class="downloadPDF<?= $pt->id; ?>"></span>
                                        ...
                                        <button type="button" class="btn btn-primary approve<?= $pt->id; ?>" onclick="generateQuote(<?= $pt->id; ?>)">Approve</button>
                                        <span class="load-approve<?= $pt->id; ?>"></span>
                                    </td>
                                </tr>
                                @endforeach
                                @else
    ...
    <div class="modal-dialog modal-lg" role="document" style="max-width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <input type="hidden" id="s_type" value="RFQ">
                            ...
                            <div class="content_wrapper">
                                ...
                                <div class="tab_content active">
                                    <div class="container">
                                        ...
                                        <div class="row hideForm" style="width: 950px;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <span id="popup_amc_value">Rs. </span>
