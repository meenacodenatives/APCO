    ...
    <div class="wrap-login100 p-6">
        <form class="login100-form validate-form">
            ...
            <label class="custom-control custom-checkbox mt-4">
                ...
                <span class="custom-control-label">Agree the <a href="{{url('/' . $page='terms')}}">terms and
                        policy</a></span>
            </label>
            ...
            <div class="text-center pt-3">
                <p class="text-dark mb-0">Already have account?<a href="{{url('/' . $page='login')}}"
            ...
            <div class=" flex-c-m text-center mt-3">
                ...
                <div class="social-icons">
                    <ul>
                        <li><a class="btn  btn-social btn-block btn-google"><i class="fa fa-google-plus"></i> Sign up
                                with Google</a></li>
                        <li><a class="btn  btn-social btn-block mt-2 btn-facebook"><i class="fa fa-facebook"></i> Sign
