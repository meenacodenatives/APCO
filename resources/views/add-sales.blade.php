...
<div class="page-header">
    <div>
        ...
        <h1 class="page-title"> @if($product!='') Edit @else Add @endif Sales </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{url('/' . $page='dashboard')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{url('/' . $page='showSales')}}">Sales</a></li>
            <li class="breadcrumb-item active" aria-current="page">
                @if($product!='') Edit @else Add @endif Sales </li>
        </ol>

    </div>
    <div class="ml-auto pageheader-btn">
        <a href="{{url('/' . $page='showSales')}}" class="btn btn-cyan btn-icon text-white">
            <span>
