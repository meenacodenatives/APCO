...
class RFQController extends Controller
{
    ...
    public function addRFQ(RFQModel $RFQ)
    {
        ...
        $productList =DB::table('product')->select( DB::raw('DISTINCT on(product_name)product_name,id,product_code') )->where('product_type','Sales')->orderBy('product_name','desc')
        ->orderBy('id','asc')
    ...
    public function editRFQ($id,RFQModel $RFQ)
    {
        ...
        //Drop down
        $productList =DB::table('product')->select( DB::raw('DISTINCT on(product_name)product_name,id,product_code,actual_price') )->where('product_type','Sales')->orderBy('product_name','desc')
        ->orderBy('id','desc')
        ->orderBy('product_code','desc')
