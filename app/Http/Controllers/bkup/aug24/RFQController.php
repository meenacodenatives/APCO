...
class RFQController extends Controller
{
    ...
    public function addRFQ(RFQModel $RFQ)
    {
        ...
        $preselectProducts = '';
        $lead = '';
        $quotationNo = substr(str_shuffle("0123456789abcdefghijklmnopqrstvwxyz"), 0, 8);
        ...
        return view('add-req', compact('quotationNo','product', 'lead', 'RFQProducts', 'preselectProducts', 'rfq_discount', 'productList'));
    }
    //Add Sales
    ...
    public function viewSingleRFQ($id)
    {
        ...
        for($i=0;$i<$cntIDs;$i++)
        {
            ...
            $rfqDetails1.='<table class="table table-striped table-bordered text-nowrap  w-100">';
        ...
        $rfqDetails1.='<tr><td align="right" colspan="5" class="lightBlue">Total Product Price: ' . $RFQid->total_pdt_price . '</td></tr>';
        $rfqDetails1.='<tr><td class="w-100 text-nowrap" colspan="5">';
        $rfqDetails1.='<div class="row w-100 inner-outline">';
        $rfqDetails1.='<div class="col-md-3">';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Created At </label><span>'.date("M d Y", strtotime($RFQid->created_at))  . '</span></div>';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Labour Charge</label><span>' . $RFQid->labourcharge . '</span></div>';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Transport Charge</label><span>' . $RFQid->transportcharge . '</span></div>';
        $rfqDetails1.='</div>';
        $rfqDetails1.='<div class="col-md-3">';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Margin</label><span>' . $RFQid->margin . '</span></div>';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Proposed Value</label><span>' . $RFQid->proposed_value . '</span></div>';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">AMC</label><span>' . $RFQid->amc . '</span></div>';
        $rfqDetails1.='</div>';
        $rfqDetails1.='<div class="col-md-3">';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">AMC Value</label><span>' . $RFQid->amc_value . '</span></div>';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Discount Type</label><span>' . $RFQid->discount_type . '</span></div>';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Final Value</label><span>' . $RFQid->final_value . '</span></div>';
        $rfqDetails1.='</div>';
        $rfqDetails1.='<div class="col-md-3">';
        $rfqDetails1.='<div class="form-group"><label class="form-label lightBlue text-capitalize">Discount Value</label><span>' . $RFQid->discount_value . '</span></div>';
        $rfqDetails1.='</div>';
        $rfqDetails1.='</div>';
        $rfqDetails1.='</td></tr>';
        $rfqDetails1.='</tbody></table>';

        // $rfqDetails1.='<div class="h-divider">';
        // $rfqDetails1.='</div>';
        }
