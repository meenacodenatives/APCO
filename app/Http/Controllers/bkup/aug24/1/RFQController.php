...
class RFQController extends Controller
{
    ...
    public function viewSingleRFQ($id)
    {
        ...
        for ($i = 0; $i < $cntIDs; $i++) {
            ...
            $rfqDetails1 .= '<table class="research table table-striped table-bordered text-nowrap  w-100">';
            ...
            $rfqDetails1 .= '<tr >';
            $rfqDetails1 .= '<td onclick="quotationDetailed();">'
            . $sno . '</td>';
            ...
            $rfqDetails1 .= '<div class="showQuotation" style="display:none;"> '; 
            ...
            $rfqDetails1 .= '<table class="table table-striped table-bordered text-nowrap  w-100">';
            $rfqDetails1 .= '<thead><tr>';
            $rfqDetails1 .= '<th class="lightBlue">Total Product Price</th>';
            ...
            $rfqDetails1 .= '</tr></thead><tbody>';
            $rfqDetails1 .= '<tr>';
            $rfqDetails1 .= '<td>' . $RFQid->total_pdt_price . '</td>';
