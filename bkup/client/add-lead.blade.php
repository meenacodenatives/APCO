...
<div class="row">
    <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group classWithPad">
                                            ...
                                            if ($data['type'] == 'Edit') {
                                                if ($data['lead'][0]->location == $loc->locID) {
                                                    echo 'selected';
                                                }
                                            }
                                            ?>><?= $loc->locName ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="name" id="leadName"
                                            value="<?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->name;} ?>"
                                            placeholder="Customer Name">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label"> Contact Person</label>
                                        <input type="text" class="form-control"
                                            value="<?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->contact_name;} ?>"
                                            name="contact_name" id="leadcontactName" placeholder="Contact Person">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="leadEmail" id="leadEmail"
                                            placeholder="Email"
                                            value="<?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->email;} ?>">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label"> Phone</label>
                                        <input type="text" maxlength="10"
                                            onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                            class="form-control" name="phone" id="leadPhone"
                                            value="<?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->phone;} ?>"
                                            placeholder="Phone">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="skype"
                                            value="<?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->skype_id;} ?>"
                                            id="leadSkype" placeholder=" Skype">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label"> Website</label>
                                        <input type="text" class="form-control"
                                            value="<?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->website;} ?>"
                                            name="website" id="leadWebsite" placeholder=" Website">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <textarea class="form-control" id="address" style="resize:none"
                                            placeholder="Address"><?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->address;} ?></textarea>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label"> Description</label>
                                        <textarea class="form-control" id="description" style="resize:none"
                                            placeholder="Description"><?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->description;} ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6 ">
                                        ...
                                        <select class="form-control custom-select" id="company_type"
                                            data-placeholder="Select" style="resize:none">
                                            <option value="">Select</option>
                                ...
                                <div class="row">
                                    <div class="col-6 ">
                                        ...
                                        <textarea class="form-control" id="remarks" style="resize:none"
                                            placeholder="Remarks"><?php if ($data['type'] == 'Edit') {echo $data['lead'][0]->remarks;} ?></textarea>
                                    </div>
                                    <div class="col-6">
                                        <div style="padding-top:25px;" class="card-footer pull-right  ebtn  pr-2">
                                            <a href="javascript:;" onclick="createLead()"
        ...
        <input type="hidden" id="editReg" value="<?= $data['lead'][0]->region ?>">
        <input type="hidden" id="editLoc" value="<?= $data['lead'][0]->location ?>">
