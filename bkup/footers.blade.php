				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<footer class="main-footer pl-0 pr-0">
								<div class="row">
									<div class="col-xl-8 col-lg-12 col-md-12 footer1">
										Copyright ©Splite 2018. Design By<a href="https://spruko.com/"> Spruko</a>
									</div>
						...
						<div class="card-body">
							<div class="top-footer">
								<div class="row">
									...
									<div class="col-lg-4 col-md-12">
										<h6>Posts</h6>
										<img alt="" src="{{URL::asset('assets/images/media/media1.jpg')}}">
										<img alt="" src="{{URL::asset('assets/images/media/media2.jpg')}}">
										<img alt="" src="{{URL::asset('assets/images/media/media3.jpg')}}">
										<img alt="" src="{{URL::asset('assets/images/media/media4.jpg')}}">
										<hr>
