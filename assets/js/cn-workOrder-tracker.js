...
$(document).ready(function() {
    ...
    $(document).on("click", ".workOrderTracker", function(e) {
        ...
        $('.showContactName').text(clientName);
        console.log("clientName"+clientName);
        $('#trac_WO_id').val(WorkOrderID);
        $('#scheduler_WO_name').val(clientName);
        var data = {}
        data.trac_WO_id = $('#trac_WO_id').val();
        $.ajax({
            url: base_url + '/WOTracker/' + data.trac_WO_id,
            type: 'GET',
            dataType: 'JSON',
...
$('.saveWOScheduler').on('click', function() {
    var data = {}
  //  data.name = $('#scheduler_WO_name').val();//Client Name

    data.contact_type = $('#contact_type').val();
    data.notify_users = $('#notify_users').val();
    data.comment = $('#comment').val();
    data.WO_id = $('#trac_WO_id').val();
    var count = $('#notify_users').find('option:selected').length;

    //Scheduler
    data.type_id = $('#trac_WO_id').val();
    data.region = $('#region').val();
    data.desc = $('#scheduler_WO_name').val(); //Client Name
...
$('.saveWOTracker').on('click', function() {
    console.log("TETRACKER");
    var data = {}
    data.name = $('#scheduler_WO_name').val();
    ...
    console.log("INPUTWOTRACKER"+JSON.stringify(data));
